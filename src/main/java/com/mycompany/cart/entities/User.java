 ...
 */
package com.mycompany.cart.entities;
...
public class User {
    ...
    private int userId;
    @Column(length = 1000,name="user_name")
    private String userName;
    @Column(length = 1000,name="user_email")
    ...
    @Column(length = 1005,name = "user_address")
    ...
    public void setUserTpye(String userType) {
        this.userType = userType;
    }
